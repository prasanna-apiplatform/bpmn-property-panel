...
function customInputParameter(bpmnFactory) {

  var inputParameter = bpmnFactory.create('camunda:InputParameter', {
    type: 'String',
    name: 'akey',
    value: 'avalue'
  });
...
module.exports.customInputParameter = customInputParameter;
