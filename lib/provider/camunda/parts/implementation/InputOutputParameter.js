...
module.exports = function(element, bpmnFactory, options, translate) {
  ...
  entries.push(entryFactory.table({
    ...
    addElement: function(element, node) {
      console.log('addElement-createElement');
      var bo = getSelected(element, node);
...
module.exports.createInputOutParametersMap = createInputOutParametersMap
function createInputOutParametersMap(element, bpmnFactory, options, translate){
  var bo = getSelected(element, node);
  var getSelected = options.getSelectedParameter;
  var createParameterTypeElem = function(type) {
    return createElement(type, bo, bpmnFactory);
  };
  createParameterTypeElem('camunda:Map');
}
